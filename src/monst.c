...
NEARDATA struct permonst mons[] = {
	...
	MON("gray ooze", S_BLOB, LVL(3, 1, 8, 0, 0), (G_GENO | G_NOCORPSE | 2),
	...
	MON("brown pudding", S_BLOB, LVL(5, 3, 8, 0, 0),
	...
	MON("green slime", S_BLOB, LVL(6, 6, 6, 0, 0),
	...
	MON("black pudding", S_BLOB, LVL(10, 6, 6, 0, 0),
	(G_GENO | G_NOCORPSE | 1),
    ...
    MON("black light", S_LIGHT, LVL(5, 15, 0, 0, 0),
        ...
        M2_HOSTILE | M2_NEUTER, 0, CLR_BLACK),
		MON("red light", S_LIGHT, LVL(8, 15, 0, 0, 0),
		(G_NOCORPSE | G_GENO | 2), A(ATTK(AT_EXPL, AD_PLYS, 1, 5), NO_ATTK,
			NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
			SIZ(0, 0, MS_SILENT, MZ_SMALL),
			MR_FIRE | MR_COLD | MR_ELEC | MR_DISINT | MR_SLEEP | MR_POISON
			| MR_ACID | MR_STONE,
